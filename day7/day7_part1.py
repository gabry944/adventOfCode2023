...
class Hand:
    def __init__(self, cards, type, bid):
        self.cards = cards # list of cards in integers, A = 14, K = 13, Q = 12, J = 11, T = 10
...
def test_compare_hands():
    ...
    hand1 = Hand([12, 12, 12, 11, 14], 3, 483)
    hand2 = Hand([10, 5, 5, 10, 5 ], 3, 684)
    print("hand1: ", hand1.cards, ", ", hand1.type, ", ", hand1.bid)
    print("hand2: ", hand2.cards, ", ", hand2.type, ", ", hand2.bid)
    assert compare_hands(hand1, hand2) == 1
...
def test_string_to_cards():
    assert string_to_cards("QQQJA") == [12, 12, 12, 11, 14 ]
...
def test_get_type():
    assert get_type([12, 12, 12, 11, 14 ]) == 3
    assert get_type([3, 2, 10, 3, 13]) == 1
    assert get_type([10, 5, 5, 11, 5 ]) == 3
    assert get_type([13, 13, 6, 7, 7 ]) == 2
    assert get_type([13, 10, 11, 11, 10 ]) == 2
...
def test_read_file():
    hand1 = Hand([3, 2, 10, 3, 13], 1, 765)
    hand2 = Hand([10, 5, 5, 11, 5 ], 3, 684)
    hand3 = Hand([13, 13, 6, 7, 7 ], 2, 28)
    hand4 = Hand([13, 10, 11, 11, 10 ], 2, 220)
    hand5 = Hand([12, 12, 12, 11, 14 ], 3, 483)
